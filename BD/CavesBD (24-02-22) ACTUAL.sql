...
INSERT INTO `estado_frentes` VALUES ('perforacion pernos','25%','-','fecha','alta','N','F1'),('escaner','50%','-','fecha','baja','S','F2'),('regado marina','75%','-','fecha','alta','E','F3'),('tronadura','25%','-','fecha','baja','O','F4'),('hilteo malla','50%','-','fecha','alta','N','F5'),('acuñadura','75%','-','fecha','baja','E','F6');
...
INSERT INTO `frentes` VALUES ('cabecera','CAB','1','N','activo','C','si','677','HD','S01','F1','ce1','S1','1','N'),('Calle','CAL','2','S','activo','M','No','456','PD','S02','F2','ce1','S2','2','S'),('Zanja','ZA','3','E','activo','G','Si','999','CH','S03','F3','ce1','S2','3','E'),('Fronton inyeccion','FRI','4','O','activo','C','No','233','INY','S04','F4','ce1','S1','4','O'),('Fronton extraccion','FEX','5','N','activo','M','Si','155','EXT','S05','F5','ce1','S1','5','N'),('Calle','CAL','6','E','activo','G','No','287','TI','S01','F6','ce1','S2','6','E');
...
-- Dump completed on 2022-02-24 22:38:58
