CREATE DATABASE  IF NOT EXISTS `cavesbd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cavesbd`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: cavesbd
-- ------------------------------------------------------
...
INSERT INTO `estado_frentes` VALUES ('tronadura','0','-','0','baja','E','F6','p-m-sh'),('lechado_pernos','0','-','1','alta','N','F5','p-m-sh'),('marcacion_topografica','0','-','2','baja','O','F4','p-m-sh'),('tronadura','0','-','3','alta','E','F3','p-m-sh'),('escaner','0','-','4','baja','S','F2','p-m-sh'),('perforacion_pernos','0','-','5','alta','N','F1','p-m-sh');
...
-- Dump completed on 2022-04-29  1:35:16
