...
INSERT INTO `estado_frentes` VALUES ('perforacion_pernos','25%','-','fecha','alta','N','F1','p-m-sh','1'),('escaner','50%','-','fecha','baja','S','F2','p-m-sh','2'),('regado_marina','75%','-','fecha','alta','E','F3','p-m-sh','3'),('tronadura','25%','-','fecha','baja','O','F4','p-m-sh','4'),('proyeccion_shotcrete','50%','-','fecha','alta','N','F5','p-m-sh','5'),('tronadura','75%','-','fecha','baja','E','F6','p-m-sh','6');
...
-- Dump completed on 2022-03-11 16:17:31
