...
INSERT INTO `estado_frentes` VALUES ('tronadura','0','-','00','baja','N','F6','p-m-sh','1'),('lechado_pernos','0','-','01','alta','N','F5','p-m-sh','1'),('marcacion_topografica','0','-','02','baja','N','F4','p-m-sh','1'),('tronadura','0','-','03','alta','N','F3','p-m-sh','1'),('escaner','0','-','04','baja','N','F2','p-m-sh','1'),('perforacion_pernos','0','-','05','alta','N','F1','p-m-sh','1'),('extraccion_marina','0',NULL,'2022-05-31 19:19:23','baja','N','F1','p-m-sh','2'),('tronadura','0',NULL,'2022-06-01 14:39:08','alta','N','F1','p-m-sh','1'),('tronadura','0',NULL,'2022-06-01 14:51:16','alta','N','F1','p-m-sh','2'),('perforacion_pernos','0',NULL,'2022-06-05 22:09:49','alta','N','F1','p-m-sh','1'),('proyeccion_shotcrete','0',NULL,'2022-06-05 22:10:30','alta','N','F2','p-m-sh','2'),('acuñadura','0',NULL,'2022-06-05 22:10:47','alta','N','F3','p-m-sh','1'),('instalacion_malla','0',NULL,'2022-06-05 22:13:42','alta','N','F4','p-m-sh','1'),('perforacion_avance','0',NULL,'2022-06-05 22:14:35','alta','N','F5','p-m-sh','2'),('escaner','0',NULL,'2022-06-05 22:15:19','alta','N','F6','p-m-sh','1'),('mapeo_geomecanico','0',NULL,'2022-06-08 02:35:45','alta','N','F1','p-m-sh','1'),('acuñadura','0',NULL,'2022-06-08 02:36:07','alta','N','F2','p-m-sh','1'),('instalacion_malla','0',NULL,'2022-06-08 02:36:31','alta','N','F3','p-m-sh','1'),('perforacion_avance','0',NULL,'2022-06-08 02:37:29','alta','N','F4','p-m-sh','2'),('escaner','0',NULL,'2022-06-08 02:37:53','alta','N','F5','p-m-sh','1'),('perforacion_pernos','0',NULL,'2022-06-08 02:38:27','alta','N','F6','p-m-sh','1'),('tronadura','0',NULL,'2022-06-08 02:46:02','alta','N','F6','p-m-sh','1'),('tronadura','0',NULL,'2022-06-08 03:07:56','alta','N','F2','p-m-sh','1');
/*!40000 ALTER TABLE `estado_frentes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estado_recursos`
--
...
CREATE TABLE `frentes` (
  ...
  `sigla_referencia` varchar(50) DEFAULT NULL,
...
INSERT INTO `frentes` VALUES ('Cabecera','CAB','1','N','activo','C','Si','677','HD','S01','F1','ce1','S1','2','N','0','159','p-m-sh','Calle','CAL'),('Calle','CAL','2','N','activo','M','No','456','PD','S02','F2','ce1','S1','1','S','1','247','p-m-sh','Cabecera','CAB'),('Zanja','ZA','3','N','activo','G','Si','999','CH','S03','F3','ce1','S1','6','E','0','368','p-m-sh','Calle','CAL'),('Fronton inyeccion','FRI','4','N','activo','C','No','233','INY','S04','F4','ce1','S1','2','O','0','495','p-m-sh','Calle','CAL'),('Fronton extraccion','FEX','5','N','activo','M','Si','155','EXT','S05','F5','ce1','S1','6','N','1','579','p-m-sh','Calle','CAL'),('Calle','CAL','6','N','activo','C','No','287','TI','S01','F6','ce1','S1','1','E','0','667','p-m-sh','Cabecera','CAB');
...
-- Dump completed on 2022-06-13 11:31:32
